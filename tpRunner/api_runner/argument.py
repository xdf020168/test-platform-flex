...
# set api subparsers
# =============================
def set_api_runner_subparsers(action):
    """
    set subparsers for api_runner
    :param action:
    :return:
    """

    # api
    sub_parser = action.add_parser('api', help='sub command of API TEST')
    sub_parser.set_defaults(module='api')
