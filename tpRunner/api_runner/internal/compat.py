...
from api_runner.internal.builtin_loader import load_project_meta, convert_relative_project_root_dir
from api_runner.internal.parser import parse_data
...
def compat_path_sep(path_string: Text) -> Text:
    """
    Linux和Windows平台路径分隔符差异兼容处理
    :param path_string: 路径字符串
    :return:
    """
    if "/" in path_string:
        path_string = os.sep.join(path_string.split("/"))
